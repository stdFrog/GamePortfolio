...
/*
	...
	참고로, WinAPI에는 SetWorldTransform이라는 함수와 XForm 즉, 3x3 크기의 행렬이 이미 설계되어 있다.
	다만, 내부 구조나 종류를 다 알지 못하므로 이처럼 직접 만들어 사용하는 것이 일반적이다.
	
	책에 설명된 윈도우의 4가지 좌표 공간의 설명이 꽤나 중요하니 꼭 기억해두자.
*/
class Vector
{
public:
